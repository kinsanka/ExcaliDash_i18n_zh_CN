...
This fork publishes `kinsanka/excalidash-backend` and `kinsanka/excalidash-frontend`. Pin a Chinese release with `APP_TAG=v0.6.0-zh.5` for reproducible deployments.
